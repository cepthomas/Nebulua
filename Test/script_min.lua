...
-- Channels
local hnd_piano = li.open_output_channel(dev_out1, 1, "Piano", 2)
local hnd_synth = li.open_output_channel(dev_out1, 2, "Synth", 90)
local hnd_drums = li.open_output_channel(dev_out1, 10, "Drums", 8)
local hnd_input = li.open_input_channel(dev_in1, 3, "Midi Input 3")
