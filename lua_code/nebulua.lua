...
print('>>>', chan_hnd, start_tick)
    ...
    ----- Local functions to package an event. ------
...
-- print('make_note_event', start_tick + offset, offset, event_offset)
