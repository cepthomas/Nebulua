...
--  Could be F4 Bb2+ E#5-
-- @param snote string The root of the note with optional +- octave shift. FUTURE multiple octaves?
...
-- @param sinterval string The interval name with optional +- octave shift. FUTURE multiple octaves?
-- @return The number or nil if invalid.
